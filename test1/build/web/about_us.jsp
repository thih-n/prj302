        ...
        <section id="content">
            ...
            <div class="content-wrap notoppadding nobottompadding">
                ...
                <section id="section_about" class="corner clearfix" style=" background-image: url('images/banner/banner15.png');">
                    <div class="container">
                        <h2 style="font-family: Roboto;font-size: 48px; margin-top: 50px">Watch
                            <span style="font-family: Roboto;color: #ff5722;">
                                Store
                            </span>
                        </h2>
                        <h3 style="font-weight: 400;">
                            Cửa hàng phân phối đồng hồ chính hãng tại Việt Nam
                        </h3>
                            ...
                            <div class="col-sm-12 col-md-9 col-md-offset-3 pad0">
                                <div class="section_content">
                                    ...
                                    <div class="section_inspiration_content">
                                        <p>
                                            Chúng tôi tự hào mang đến cho quý khách hàng những sản phẩm đồng hồ chính hãng, đảm bảo về chất 
                            ...
                            <div class="col-sm-12 col-md-9">
                                <div class="section_content">
                                    ...
                                    <blockquote class="section_material_1_quote"><i>Chúng tôi hiểu rằng mỗi người đều có cái 
                                            tôi riêng biệt, vì vậy chúng tôi không chỉ cung cấp những sản phẩm phổ biến mà còn 
                                            mang đến những dòng đồng hồ độc đáo và nổi bật</i></blockquote>

                                    <div class="section_material_1_content">
                                        Perfume Paradise tự hào mang đến cho quý khách hàng một bộ sưu tập đồng hồ đa dạng và phong phú,
                                        từ những nguyên liệu phổ biến cho đến những nguyên liệu quý hiếm.
                ...
                <div id="section_contact" class="page-section nobottompadding notoppadding"  style="padding: 0">
                    <div class="row noleftmargin norightmargin common-height">
                        <div class='index_map col-md-6 col-sm-6 hidden-xs nopadding'>
                            <iframe
                                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3724.5728981343755!2d105.53258411095528!3d21.0097509883502!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x31345bb9d76a7e03%3A0x244a83c591357341!2zRlBUIFNvZnR3YXJlIEjDsmEgTOG6oWM!5e0!3m2!1sen!2s!4v1720342703420!5m2!1sen!2s"
                            ...
                            <div class="max-height" style='padding: 60px 30px'>
                                ...
                                <div style="line-height: 1.7;">
                                    ...
                                    <address style="line-height: 1.7; font-size: 16px; color: #dbdbdb ;">
                                        ...
                                        Hòa Lạc, Hà Nội<br>
                                        Hotline: 1900 9191<br />
                                        Email: dongnguyen1968hldh@gmail.com
                                    </address>
